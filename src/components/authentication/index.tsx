...
export default function Index() {
  return(
    <div className='flex '>
      <div className="logo xsm:hidden lg:flex">Logo</div>
      <div className="form      h-auto flex justify-center items-center" >
        <form className='py-2 my-5 rounded-lg dark:bg-slate-900 bg-slate-300 px-3 w-8/12 h-auto flex flex-col  justify-center'>
        ...
        <div className='flex flex-col items-center '>
          <label className=' w-full pb-3'>
            ...
            <input className='w-full dark:bg-black bg-slate-200 rounded border border-slate-400' type="text" placeholder='Enter your Username' />
          </label>
          <label className='w-full pb-3'>
            <div className='font-medium'>Password</div>
            <input className='border border-slate-400 rounded w-full dark:bg-black bg-slate-200' type="password" placeholder='Enter your Password' />
          </label>
